...
\begin{itemize}
	...
	\item Se \(k = -25\):
		\[\begin{array}{r|rrr}
			\tikzmark{e211bm4} s^4 &    1 & 33 & 25 \\
			\tikzmark{e211bm3} s^3 &    9 & 50 	\\
			\tikzmark{e211bm2} s^2 &  247 &  0	\\
			\tikzmark{e211bm1} s^1 & 2950		\\
					   s^0 & 0 		\\
			\midrule
			\tikzmark{e211bm0} s^0 & 2950
		\end{array}\]
		\begin{tikzpicture}[overlay, remember picture, yshift=.25\baselineskip, shorten >=.5pt, shorten <=.5pt]
			\draw [->] ({pic cs:e211bm4}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211bm3});
			\draw [->] ({pic cs:e211bm3}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211bm2});
			\draw [->] ({pic cs:e211bm2}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211bm1});
			\draw [->] ({pic cs:e211bm1}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211bm0});
		\end{tikzpicture}
		\[\begin{cases}
			1 \text{ polo all'origine} 	\\
			3 \text{ poli con } \Re s_i < 0
	...
	\item Se \(-25 < k < 0\):
		\[\begin{cases}
			4 \text{ poli con } \Re s_i < 0
		\end{cases} \implies \text{sistema \emph{asintoticamente stabile}}\]
	\item Se \(k = 0\):
		\[\begin{array}{r|rrr}
			\tikzmark{e211cm4} s^4 &   1 & 33 & 0	\\
			\tikzmark{e211cm3} s^3 &   9 & 25	\\
			\tikzmark{e211cm2} s^2 & 272 &  0	\\
			\tikzmark{e211cm1} s^1 & 850		\\
					   s^0 & 0		\\
			\midrule
			\tikzmark{e211cm0} s^9 & 850
		\end{array}\]
		\begin{tikzpicture}[overlay, remember picture, yshift=.25\baselineskip, shorten >=.5pt, shorten <=.5pt]
			\draw [->] ({pic cs:e211cm4}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211cm3});
			\draw [->] ({pic cs:e211cm3}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211cm2});
			\draw [->] ({pic cs:e211cm2}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211cm1});
			\draw [->] ({pic cs:e211cm1}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211cm0});
		\end{tikzpicture}
		\[\begin{cases}
			1 \text{ polo all'origine} 	\\
			3 \text{ poli con } \Re s_i < 0
	...
	\item Se \(k = 25\):
		\[\begin{array}{r|rrr}
			\tikzmark{e211dm4} s^4 &     1 &    33 & -25 \\
			\tikzmark{e211dm3} s^3 &     9 &     0	     \\
			\tikzmark{e211dm2} s^2 &   247 & -1250	     \\
					   s^1 &     0		     \\
			\midrule
			\tikzmark{e211dm1} s^1 &   494		     \\
			\tikzmark{e211dm0} s^0 & -1250
		\end{array}\]
		\begin{tikzpicture}[overlay, remember picture, yshift=.25\baselineskip, shorten >=.5pt, shorten <=.5pt]
			\draw [->] ({pic cs:e211dm4}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211dm3});
			\draw [->] ({pic cs:e211dm3}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211dm2});
			\draw [->] ({pic cs:e211dm2}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211dm1});
			\draw [->] ({pic cs:e211dm1}) [bend right] to node[left]{\scriptsize v} ({pic cs:e211dm0});
		\end{tikzpicture}
		\[\begin{cases}
			3 \text{ poli con } \Re s_i > 0 \\
			1 \text{ polo con } \Re s   < 0
	...
	\item Se \(k = 34\):
		\[\begin{array}{r|rrr}
			\tikzmark{e211em4} s^4 &     1 &    33 & -34 	\\
			\tikzmark{e211em3} s^3 &     9 &    59		\\
			\tikzmark{e211em2} s^2 &   238 & -2006		\\
					   s^1 &     0			\\
			\midrule
			\tikzmark{e211em1} s^1 &   476			\\
			\tikzmark{e211em0} s^0 & -2006
		\end{array}\]
		\begin{tikzpicture}[overlay, remember picture, yshift=.25\baselineskip, shorten >=.5pt, shorten <=.5pt]
			\draw [->] ({pic cs:e211em4}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211em3});
			\draw [->] ({pic cs:e211em3}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211em2});
			\draw [->] ({pic cs:e211em2}) [bend right] to node[left]{\scriptsize p} ({pic cs:e211em1});
			\draw [->] ({pic cs:e211em1}) [bend right] to node[left]{\scriptsize v} ({pic cs:e211em0});
		\end{tikzpicture}
		\[\begin{cases}
			3 \text{ poli con } \Re s_i > 0 \\
			1 \text{ polo con } \Re s   < 0
		\end{cases} \implies \text{sistema \emph{instabile}}\]
	\item Se \(34 < k \leq 272\):
		\[\begin{cases}
			1 \text{ polo con } \Re s   > 0 \\
			3 \text{ poli con } \Re s_i < 0
		\end{cases} \implies \text{sistema \emph{instabile}}\]
